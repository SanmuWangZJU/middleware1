...
//        System.out.print("Message---------------" +"header Key: [");
//        for(String s : message.headers().keySet()){
//        	System.out.print( s  + ":"+ message.headers().getString(s)+",");
//        }
//        System.out.println("]");
//
...
//        }
//        System.out.print(" properties Key: [");
//        for(String s : message.properties().keySet())
//        	System.out.print(s  + ":"+ message.properties().getString(s) +",");
